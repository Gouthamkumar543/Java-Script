...
document.addEventListener("click", (event) => {
    switch (event.target.id) {
        case 'Appliances':
            ...
            page.innerHTML = `
            <img src="https://m.media-amazon.com/images/I/81orA+t+QdL.SX425.jpg" alt="Home Image" />
        ...
        case 'Dress':
            ...
            page.innerHTML = `
            <img src="https://m.media-amazon.com/images/I/61SgADmAyDL.SY879.jpg" alt="" width=300 height=300/>
        ...
        case 'phones':
            ...
            page.innerHTML = `
            <img src="https://m.media-amazon.com/images/I/41kLJXobHXL.SX300_SY300_QL70_FMwebp.jpg" alt="" />
        ...
        case 'furniture':
            ...
            page.textContent = "Hello everyone, complete the assignment";
            page.innerHTML = `
            <img src="https://m.media-amazon.com/images/I/81eWfwSKbJL.AC_UL480_QL65.jpg" alt="" />
        ...
        case 'Decor':
            ...
            page.textContent = "Hello everyone, complete the assignment";
            page.innerHTML = `
            <img src="https://m.media-amazon.com/images/I/51UYS13U23L.SX300_SY300_QL70_FMwebp.jpg" alt="" />
